...
public class DishServiceImpl implements DishService {
     ...
     * @return
     */
    public PageResult list(Integer pageNumber, Integer pageSize, String dname, Integer categoryId, Integer flavorId, String ingredient) {
        PageResult<DishVO> pageResult = new PageResult<>();
        PageHelper.startPage(pageNumber, pageSize);
        //将食材转换为列表
        List<String> ingredientList = List.of(ingredient.split("_"));

        Page<DishVO> page = dishMapper.list(dname, categoryId, flavorId, ingredientList);
